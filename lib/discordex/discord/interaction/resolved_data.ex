defmodule Discordex.Discord.Interaction.ResolvedData do
  @moduledoc """
  ...
  alias Discordex.Discord.{User, GuildMember, Role, Channel, Message, Attachment}
...
defimpl Discordex.Discord.Encodable, for: Discordex.Discord.Interaction.ResolvedData do
