defmodule Discordex.Discord.Components.MediaGallery do
  @moduledoc """
...
defimpl Discordex.Discord.Encodable, for: Discordex.Discord.Components.MediaGallery do
  def to_map(gallery) do
    %{
      type: 12,
      items: Enum.map(gallery.items, &Discordex.Discord.Encodable.to_map/1)
    }
    |> Discordex.Discord.Encodable.Helpers.maybe_put(:id, gallery.id)
  end
end
