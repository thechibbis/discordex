defmodule Discordex.Discord.Components.Container do
  @moduledoc """
...
defimpl Discordex.Discord.Encodable, for: Discordex.Discord.Components.Container do
  def to_map(container) do
    %{
      type: 17,
      components: Enum.map(container.components, &Discordex.Discord.Encodable.to_map/1),
      spoiler: container.spoiler
    }
    |> Discordex.Discord.Encodable.Helpers.maybe_put(:id, container.id)
    |> Discordex.Discord.Encodable.Helpers.maybe_put(:accent_color, container.accent_color)
  end
end
