...
defimpl Discordex.Discord.Encodable, for: Discordex.Discord.Components.StringSelect do
  def to_map(select) do
    %{
      type: 3,
      custom_id: select.custom_id,
      options: Enum.map(select.options, &Discordex.Discord.Encodable.to_map/1),
