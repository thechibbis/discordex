defmodule Discordex.Types.GuildMember do
  @moduledoc """
...
defimpl Discordex.Types.Encodable, for: Discordex.Types.GuildMember do
  ...
  defp maybe_put_user(map, user) do
    Map.put(map, :user, Discordex.Types.Encodable.to_map(user))
  end
end
