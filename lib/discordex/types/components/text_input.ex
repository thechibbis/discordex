defmodule Discordex.Types.Components.TextInput do
  @moduledoc """
...
defimpl Discordex.Types.Encodable, for: Discordex.Types.Components.TextInput do
  def to_map(input) do
    %{
      type: 4,
    ...
    |> Discordex.Types.Encodable.Helpers.maybe_put(:id, input.id)
    |> Discordex.Types.Encodable.Helpers.maybe_put(:min_length, input.min_length)
    |> Discordex.Types.Encodable.Helpers.maybe_put(:max_length, input.max_length)
    |> Discordex.Types.Encodable.Helpers.maybe_put(:value, input.value)
    |> Discordex.Types.Encodable.Helpers.maybe_put(:placeholder, input.placeholder)
  end
