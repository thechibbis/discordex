defmodule Discordex.Types.Components.TextDisplay do
  @moduledoc """
...
defimpl Discordex.Types.Encodable, for: Discordex.Types.Components.TextDisplay do
  def to_map(display) do
    %{
      type: 10,
      content: display.content
    }
    |> Discordex.Types.Encodable.Helpers.maybe_put(:id, display.id)
  end
end
