defmodule Discordex.Types.Components.UserSelect do
  @moduledoc """
  Discord User Select component.

  See: https://discord.com/developers/docs/interactions/message-components#user-select
  """
  ...
  def new(_, _), do: {:error, :invalid_user_select}
...
defimpl Discordex.Types.Encodable, for: Discordex.Types.Components.UserSelect do
