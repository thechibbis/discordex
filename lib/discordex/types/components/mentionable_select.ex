defmodule Discordex.Types.Components.MentionableSelect do
  @moduledoc """
  Discord Mentionable Select component.

  See: https://discord.com/developers/docs/interactions/message-components#mentionable-select
  """
  ...
  def new(_, _), do: {:error, :invalid_mentionable_select}
...
defimpl Discordex.Types.Encodable, for: Discordex.Types.Components.MentionableSelect do
