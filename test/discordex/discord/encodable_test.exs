defmodule Discordex.Discord.EncodableTest do
  use ExUnit.Case, async: true

  alias Discordex.Discord.Encodable
  alias Discordex.Discord.Encodable.Helpers, as: E
  ...
  describe "UnfurledMediaItem" do
    test "encodes url" do
      media = %Discordex.Discord.UnfurledMediaItem{url: "https://example.com/img.png"}
      assert Encodable.to_map(media) == %{url: "https://example.com/img.png"}
    end

    test "encodes attachment reference" do
      media = %Discordex.Discord.UnfurledMediaItem{url: "attachment://game.zip"}
  ...
  describe "DefaultValue" do
    test "encodes user type" do
      dv = %Discordex.Discord.DefaultValue{id: "111", type: :user}
      assert Encodable.to_map(dv) == %{id: "111", type: "user"}
    end

    test "encodes role type" do
      dv = %Discordex.Discord.DefaultValue{id: "222", type: :role}
      assert Encodable.to_map(dv) == %{id: "222", type: "role"}
    end

    test "encodes channel type" do
      dv = %Discordex.Discord.DefaultValue{id: "333", type: :channel}
  ...
  describe "ComponentType" do
    alias Discordex.Discord.Components.ComponentType
  ...
  describe "ButtonStyle" do
    alias Discordex.Discord.Components.ButtonStyle
  ...
  describe "ActionRow" do
    alias Discordex.Discord.Components.{ActionRow, Button}
  ...
  describe "StringSelect" do
    alias Discordex.Discord.Components.{StringSelect, StringSelect.Option}
  ...
  describe "StringSelect.Option" do
    alias Discordex.Discord.Components.StringSelect.Option
  ...
  describe "UserSelect" do
    alias Discordex.Discord.Components.UserSelect
  ...
  describe "RoleSelect" do
    alias Discordex.Discord.Components.RoleSelect
  ...
  describe "MentionableSelect" do
    alias Discordex.Discord.Components.MentionableSelect
  ...
  describe "ChannelSelect" do
    alias Discordex.Discord.Components.ChannelSelect
  ...
  describe "TextInput" do
    alias Discordex.Discord.Components.TextInput
  ...
  describe "TextDisplay" do
    alias Discordex.Discord.Components.TextDisplay
  ...
  describe "Thumbnail" do
    alias Discordex.Discord.Components.Thumbnail
  ...
  describe "MediaGallery" do
    alias Discordex.Discord.Components.MediaGallery
    alias Discordex.Discord.Components.MediaGallery.Item
    alias Discordex.Discord.UnfurledMediaItem
  ...
  describe "File" do
    alias Discordex.Discord.Components.File
    alias Discordex.Discord.UnfurledMediaItem
  ...
  describe "Separator" do
    alias Discordex.Discord.Components.Separator
  ...
  describe "Container" do
    alias Discordex.Discord.Components.{Container, TextDisplay}
  ...
  describe "Section" do
    alias Discordex.Discord.Components.{Section, TextDisplay, Thumbnail}
    alias Discordex.Discord.Components.Button
    alias Discordex.Discord.UnfurledMediaItem
  ...
  describe "Label" do
    alias Discordex.Discord.Components.{Label, TextInput}
